...
function createScene() {
    let bandArgs = {n: 40, minTheta: Math.PI/800, maxTheta: Math.PI/50, rad: 4, segments: 96, density: 40};
...
function initGui() {
    ...
    mapFolder.add(controls, 'basis1');
    mapFolder.add(controls, 'basis2');
    mapFolder.add(controls, 'basis3');
...
function createSphericalBandGeometry(rad = 1, theta = Math.PI / 4, segments = 96, density = 100) {
